...
final class RestAuthorizationMatrixTest extends WP_UnitTestCase {
	 ...
	 *
	 * @return array<string, 'public'|'authenticated'|'account'|'owner'|'technician'|'manager'>
	 */
	private function expected_matrix(): array {
		return array(
			'GET /plumberslot/v1/audit'                    => 'manager',
			'GET /plumberslot/v1/availability/(?P<technician_id>\d+)' => 'owner',
			'PUT /plumberslot/v1/availability/(?P<technician_id>\d+)' => 'owner',
			'GET /plumberslot/v1/availability/(?P<technician_id>\d+)/exceptions' => 'owner',
			'POST /plumberslot/v1/availability/(?P<technician_id>\d+)/exceptions' => 'owner',
			'DELETE /plumberslot/v1/availability/(?P<technician_id>\d+)/exceptions/(?P<id>\d+)' => 'owner',
			'POST /plumberslot/v1/availability/(?P<technician_id>\d+)/defaults' => 'owner',
			...
			'POST /plumberslot/v1/bookings/(?P<id>\d+)/attendance' => 'technician',
			'POST /plumberslot/v1/bookings/(?P<id>\d+)/notes' => 'technician',
			'POST /plumberslot/v1/bookings/(?P<id>\d+)/review' => 'authenticated',
			'GET /plumberslot/v1/reviews'                  => 'manager',
			'POST /plumberslot/v1/reviews/(?P<id>\d+)/status' => 'manager',
			...
			'GET /plumberslot/v1/dashboard'                => 'technician',
			'GET /plumberslot/v1/meetings/providers'       => 'technician',
			'GET /plumberslot/v1/meetings/google/connect'  => 'technician',
			'GET /plumberslot/v1/meetings/google/callback' => 'public',
			'POST /plumberslot/v1/meetings/google/disconnect' => 'technician',
			...
			'POST /plumberslot/v1/payments/booking/(?P<booking_id>\d+)/refund' => 'technician',
			...
			'GET /plumberslot/v1/public/technicians/(?P<id>[\d]+)' => 'public',
			'GET /plumberslot/v1/public/technicians/by-slug/(?P<slug>[a-z0-9\-]+)' => 'public',
			'POST /plumberslot/v1/series'                  => 'account',
			'GET /plumberslot/v1/series/(?P<id>\d+)'       => 'owner',
			'DELETE /plumberslot/v1/series/(?P<id>\d+)'    => 'owner',
			'GET /plumberslot/v1/setup'                    => 'technician',
			'POST /plumberslot/v1/setup'                   => 'technician',
			'GET /plumberslot/v1/slots'                    => 'public',
			'GET /plumberslot/v1/technicians/(?P<technician_id>\d+)/services' => 'owner',
			'POST /plumberslot/v1/technicians/(?P<technician_id>\d+)/services' => 'owner',
			'PATCH /plumberslot/v1/technicians/(?P<technician_id>\d+)/services/(?P<id>\d+)' => 'owner',
			'DELETE /plumberslot/v1/technicians/(?P<technician_id>\d+)/services/(?P<id>\d+)' => 'owner',
			'GET /plumberslot/v1/technicians'              => 'manager',
			'POST /plumberslot/v1/technicians'             => 'manager',
			'GET /plumberslot/v1/technicians/(?P<id>\d+)'  => 'manager',
			'PATCH /plumberslot/v1/technicians/(?P<id>\d+)' => 'manager',
			'POST /plumberslot/v1/technicians/(?P<id>\d+)/resend' => 'manager',
